...
@ContextConfiguration(locations = "classpath:log-basic-test.xml")
public class ChannelLoggingBeanDefinitionParserBasicTest {

    @Autowired
    private ApplicationContext ctx;
    @Resource(name = "test.in")
    ...
    public void shouldLoadDefaultAuditConfiguration() {
        ...
        assertNotNull(ctx.getBean(GlobalChannelInterceptorBeanPostProcessor.class));
    }
